...
class ModelsTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.test_user = User.objects.create_user(username="test", first_name=cls.first_name, last_name=cls.last_name)

        cls.test_giphouse_user = GiphouseProfile.objects.create(user=cls.test_user, github_id=1)
    ...
    def test_giphouseprofile_str(self):
        ...
        self.assertEqual(f"{self.first_name} {self.last_name}", str(self.test_giphouse_user))
