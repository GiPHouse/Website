...
class Step2Form(forms.Form):
    ...
    experience = forms.ChoiceField(
        ...
        help_text="<strong>Beginner</strong>: I barely passed the programming "
        "courses from my curriculum.<br>"
        "<strong>Intermediate</strong>: the programming courses in "
        "the curriculum were very easy for me and I have experience "
