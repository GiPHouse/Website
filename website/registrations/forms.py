...
class Step2Form(forms.Form):
    ...
    attendance = forms.ChoiceField(
        ...
        help_text="In this course, it is highly recommended to work face-to-face in the same working room as your groupmates. Are you able to physically attend group meetings at Radboud University? Or would you prefer to collaborate only online (even if this makes the course harder)",
