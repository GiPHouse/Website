...
DJANGO_GITHUB_SYNC_APP_INSTALLATION_ID = os.environ['DJANGO_GITHUB_APP_INSTALLATION_ID']
DJANGO_GITHUB_SYNC_REPO_PRIVATE = os.environ['DJANGO_GITHUB_SYNC_REPO_PRIVATE'] == 'True'
